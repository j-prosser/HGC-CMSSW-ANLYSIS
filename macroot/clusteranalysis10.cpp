...
std::string base_path = "data/10/maxenerey/";
//Directory Selection
std::string basic_name = "logene2"; // esplit, euclid
//Clustering Methods
...
std::string filepath_0 = base_path+basic_name+"/"+"pu0_s0_100.root";
std::string filepath_1 = base_path+basic_name+"/"+"pu200_s0_100.root";
std::string filepath_2 = base_path+basic_name+"/"+"pu200_s100_100.root";
std::string filepath_3 = base_path+basic_name+"/"+"pu200_s200_100.root";
std::string filepath_4 = base_path+basic_name+"/"+"pu200_s300_100.root";
std::string filepath_5 = base_path+basic_name+"/"+"pu200_s400_100.root";
std::string filepath_6 = base_path+basic_name+"/"+"pu200_s500_100.root";
std::string filepath_7 = base_path+basic_name+"/"+"pu200_s600_100.root";
std::string filepath_8 = base_path+basic_name+"/"+"pu200_s700_100.root";
std::string filepath_9 = base_path+basic_name+"/"+"pu200_s800_100.root";
std::string filepath_10= base_path+basic_name+"/"+"pu200_s900_100.root";
